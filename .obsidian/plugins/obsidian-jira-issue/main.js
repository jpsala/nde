...
var JiraIssueSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  displayExtraSettings() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Log Request and Responses").setDesc("Log in the console (CTRL+Shift+I) all the API requests and responses performed by the plugin.").addToggle((toggle) => toggle.setValue(SettingsData.logRequestsResponses).onChange(async (value) => {
